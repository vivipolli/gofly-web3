  ...
  return (
    <footer className="text-black dark:text-gray-300 body-font">
      <div className="container flex flex-col items-center px-10 pb-8 mx-auto border-t border-purple-600 dark:border-purple-300 sm:flex-row">
        <Link href="/">
          <span className="flex items-center text-transparent bg-clip-text bg-gradient-to-r dark:bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 justify-center mt-3 text-xl font-medium title-font md:ml-3 md:justify-start">
            GOFLY
          </span>
        </Link>
