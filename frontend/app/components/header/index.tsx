...
import { Account } from "../wallet-conection/Account";
import { WalletOptions } from "../wallet-conection/WalletOptions";
		...
		<header className="w-full sticky-nav">
			<div className="flex flex-col flex-wrap max-w-5xl p-2.5 mx-auto md:flex-row">
				<div className="flex flex-row items-center justify-between p-2 md:p-1">
					<Link href="/">
						<span className="mb-4 text-2xl font-medium text-transparent bg-clip-text bg-gradient-to-r dark:bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 transition duration-300 dark:text-gray-300 md:mb-0">
							GOFLY
						</span>
					</Link>
					<button
